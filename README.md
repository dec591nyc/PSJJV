...
💡 **治安統計分析平台結合多項新穎技術開發完成，如 Next.js 數據儀表板、 Python 數據整理及 n8n 自動化數據 ETL 流水線，於每月週期性抓取內政部刑事案件數據集（代號 9603）進行資訊校對、數據統計，最後以視覺化的呈現提供民眾一個可直觀理解全國縣市各類犯罪趨勢、分布及 YoY 增減變化的儀表板。**
